...
public class GetCommand extends AbstractCommand{
	...
	public GetCommand(MQMessageExt message){
	...
	public Object getSendObject() {
		...
		requestBuilder.setServiceName(Command.COMMAND_GET);
		...
		ProtoUtil.setField(requestBuilder, MessageMapping.FIELD_CONSUMER_GROUP, message.getConsumerGroupName());
