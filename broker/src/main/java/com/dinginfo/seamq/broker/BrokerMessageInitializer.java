...
public class BrokerMessageInitializer extends
		ChannelInitializer<SocketChannel> {
	private ServiceContext context;
	private ExecutorService executorService;
	private LinkedBlockingQueue taskQueue;
	public BrokerMessageInitializer(ServiceContext context,ExecutorService executorService,LinkedBlockingQueue taskQueue){
	...
	protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast("handler", new BrokerMessageServerHandler(context,executorService,taskQueue));
